            ...
            <section className="container" style={{ marginTop: '3rem', marginBottom: '3rem' }}>
                ...
                <div className="row about-row text-center">
                    <div className="col-md-6 bg-secondary text-light p-4 font-monospace" style={{ height: '20rem' }}>
                        <h4 className='mt-5'><strong>Best Deal on Top</strong><br /><span>Sellers</span></h4>
                    ...
                    <div className="col-md-6 bg-dark text-light p-4 font-monospace">
                        <h4 className='mt-5'>GET 30% OFF</h4>
                        <h4><strong>Autocar Repair</strong><br /><span>Parts</span></h4>
                        <MDBBtn color='light' rippleColor='dark'>
                            Shop Now
                        </MDBBtn>                    </div>
                </div>
