     ...
     <section className='container'>
        <Row className='mt-5 mobile-margin'>
          <Col lg={6} className='order-2'>
            <h2 className='text-success'>Our excellent mobile tyre fitting in London</h2>
            <p>Welcome to the hub of the best tyres and tyre services that solve all your tyre-related problems. Pro Tyre Fitters is a platform that provides you with the amazing tyre-related service to ensure your journey is smooth and easy. Tyre-related issues can occur anywhere at any time that can disrupt your travel schedule. It disrupts your daily travel, office work schedule, and even travel for a specific reason. This causes you to arrive late at your destination or miss an essential part of the event.</p>
          </Col>
          <Col lg={6} className='order-1 d-flex justify-content-center'>
            <img src={imgOne} alt="Mission" className="rounded img-fluid img-fix" />
          </Col>
        </Row>
      </section>
      ...
      <section className='container'>
        <Row className='mt-5'>
          ...
          <Col lg={6} className='order-1 d-flex justify-content-center'>
            <img src={imgThree} alt="Mission" className="rounded img-fluid img-fix" />
          </Col>
        </Row>
      </section>
     ...
     <div className='mt-4'>
        <div className="row text-center justify-content-center">
            <div className="col-md-11 col-lg-9 col-xl-7 mb-2">
                ...
                <p className='text-center'>Ensure your journey with our seemless services</p>
            </div>
        </div>
     </div>
